...
9. Extrahiere eindeutige Nummern und Kennungen als facts: Seriennummern, Vertragsnummern, Policennummern, Kundennummern, Rechnungsnummern, IBAN, Kfz-Kennzeichen, Mitgliedsnummern, Steuer-ID, Steuernummer, Versichertennummern, Zählernummern, Aktenzeichen, Flugnummern — alles, wonach eine Familie später fragen könnte. Übernimm den Wert EXAKT wie im Dokument (inkl. Bindestriche/Leerzeichen). Jede Nummer besteht nur aus label und value:
