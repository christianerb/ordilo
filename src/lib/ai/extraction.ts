...
7. Extrahiere Geldbeträge mit Währung und einem Label, das erklärt, WAS der Betrag ist (z.B. "Gesamtbetrag", "Bereits gezahlt", "Noch offen", "Empfohlener Beitrag pro Kind", "Monatsbeitrag") — NIEMALS generische Labels wie "Betrag" oder "Summe". Jeden Betrag nur EINMAL extrahieren, auch wenn er mehrfach im Dokument steht. Wenn erkennbar ist, dass ein Betrag bereits gezahlt wurde, extrahiere das Zahlungsdatum zusätzlich als Datum mit Label wie "Gezahlt am" — Familien wollen später wissen: Wann habe ich was gezahlt?
