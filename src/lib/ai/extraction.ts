...
9. Extrahiere eindeutige Identifikatoren als facts: Seriennummern (serial_number), Vertragsnummern (contract_number), Policennummern (policy_number), Kundennummern (customer_number), Rechnungsnummern (invoice_number), IBAN (iban), Kfz-Kennzeichen (license_plate), Mitgliedsnummern (member_id), steuerliche Identifikationsnummer/Steuer-ID/IdNr (tax_id), Steuernummer des Finanzamts, Format 12/345/67890 (tax_number), Versicherten-/Krankenversicherungsnummer (health_insurance_number), Flugnummern (other), sonstige Kennungen (other). Übernimm den Wert EXAKT wie im Dokument (inkl. Bindestriche/Leerzeichen).
   - Eine 11-stellige Zahl, oft als "12 345 678 901" gruppiert, ist in Deutschland fast immer die steuerliche Identifikationsnummer → tax_id, auch wenn das Dokument sie nicht benennt.
   - Das Label beschreibt, WOZU die Kennung gehört, und nennt die Person oder Sache dazu (z.B. "Seriennummer Waschmaschine", "Vertragsnummer Stromvertrag", "Steuer-ID Hanna"). Steht die Kennung bei einem Namen oder gehört das Dokument zu einer Person, gehört dieser Name ins Label — Familien fragen später "Wie ist die Steuer-ID von Hanna?". NIEMALS ratlose Labels wie "Unklare Kennnummer" oder "Nummer".
