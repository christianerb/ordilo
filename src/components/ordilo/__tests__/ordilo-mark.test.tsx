...
describe("OrdiloMark", () => {
  it("renders the compact hexagon elephant at the requested size", () => {
    ...
    expect(svg?.getAttribute("class")).toContain("ordilo-mark--alive");
  ...
  it("can render without ambient character animation", () => {
    const { container } = render(<OrdiloMark animate={false} />);
