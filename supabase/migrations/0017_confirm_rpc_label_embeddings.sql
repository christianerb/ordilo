-- ============================================================================
-- Confirm document RPC — updated with label_embeddings parameter
-- ============================================================================
--
-- Recreates the confirm_document function with p_label_embeddings parameter
-- so knowledge_nodes get semantic label embeddings for graph matching.
